...
public class MyProgram
{
    public static void main(String[] args)
    {
        ...
        testPlayer.addCard(new Card(26));
        testPlayer.addCard(new Card(38));
        testPlayer.addCard(new Card(37));
        testPlayer.addCard(new Card(36));
        testPlayer.addCard(new Card(35));
        testPlayer.addCard(new Card(22));
